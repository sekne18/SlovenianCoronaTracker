...
namespace Scraper
{
    public class Generator
    {
        ...
        private static void start_get(Data db)
        {
            ...
            string[] delimiter = { "}," };
            string shorted = jsonString.Split(delimiter, StringSplitOptions.RemoveEmptyEntries)[13].Replace("\"","");
            shorted += "}," + jsonString.Split(delimiter, StringSplitOptions.RemoveEmptyEntries)[14].Replace("\"","") + "}";
